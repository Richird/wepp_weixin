		...
		$allUrls = array(
			...
			array(
				...
				'list' => array(
					...
					array('name' => '待付款订单', 'url' => mobileUrl('order', array('status' => 0), $full), 'url_wxapp' => '/pages/order/index?status=0'),
					array('name' => '待发货订单', 'url' => mobileUrl('order', array('status' => 1), $full), 'url_wxapp' => '/pages/order/index?status=1'),
					array('name' => '待收货订单', 'url' => mobileUrl('order', array('status' => 2), $full), 'url_wxapp' => '/pages/order/index?status=2'),
					array('name' => '退换货订单', 'url' => mobileUrl('order', array('status' => 4), $full), 'url_wxapp' => '/pages/order/index?status=4'),
					array('name' => '已完成订单', 'url' => mobileUrl('order', array('status' => 3), $full), 'url_wxapp' => '/pages/order/index?status=3'),
					array('name' => '我的收藏', 'url' => mobileUrl('member/favorite'), 'url_wxapp' => '/pages/member/favorite/index'),
					array('name' => '我的足迹', 'url' => mobileUrl('member/history'), 'url_wxapp' => '/pages/member/history/index'),
					array('name' => '会员充值', 'url' => mobileUrl('member/recharge'), 'url_wxapp' => '/pages/member/recharge/index'),
					array('name' => '余额明细', 'url' => mobileUrl('member/log'), 'url_wxapp' => '/pages/member/log/index'),
					array('name' => '余额提现', 'url' => mobileUrl('member/withdraw'), 'url_wxapp' => '/pages/member/withdraw/index'),
					array('name' => '我的资料', 'url' => mobileUrl('member/info'), 'url_wxapp' => '/pages/member/info/index'),
					array('name' => '积分排行', 'url' => mobileUrl('member/rank'), 'url_wxapp' => ''),
					array('name' => '消费排行', 'url' => mobileUrl('member/rank/order_rank'), 'url_wxapp' => ''),
					array('name' => '消息提醒设置', 'url' => mobileUrl('member/notice'), 'url_wxapp' => ''),
					array('name' => '收货地址管理', 'url' => mobileUrl('member/address'), 'url_wxapp' => '/pages/member/address/index')
					)
				)
			);
