...
`edareas_code` varchar(500) DEFAULT '',
PRIMARY KEY (`id`),
KEY `idx_uniacid` (`uniacid`),
KEY `idx_pcate` (`pcate`),
KEY `idx_ccate` (`ccate`),
...
`streetdatavalue` varchar(255) DEFAULT '',
`datavalue` varchar(255) DEFAULT '',
PRIMARY KEY (`id`),
KEY `idx_uniacid` (`uniacid`),
KEY `idx_openid` (`openid`),
...
(2, '自提订单提交成功通知', 'carrier', 'OPENTM201594720', '1kGPTUmvgmHd79cIcyshqQ2mqMID9WuiZLkai4aNSZU', '订单付款通知', '{{first.DATA}}自提码：{{keyword1.DATA}}商品详情：{{keyword2.DATA}}提货地址：{{keyword3.DATA}}提货时间：{{keyword4.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
(3, '订单取消通知', 'cancel', 'OPENTM201764653', '40rB6AVKqDv4rHCGPQwHtpY-gMFc6kZ-y3Lb1NlRHJY', '订单关闭提醒', '{{first.DATA}}订单商品：{{keyword1.DATA}}订单编号：{{keyword2.DATA}}下单时间：{{keyword3.DATA}}订单金额：{{keyword4.DATA}}关闭时间：{{keyword5.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
(4, '订单即将取消通知', 'willcancel', 'OPENTM201764653', '40rB6AVKqDv4rHCGPQwHtpY-gMFc6kZ-y3Lb1NlRHJY', '订单关闭提醒', '{{first.DATA}}订单商品：{{keyword1.DATA}}订单编号：{{keyword2.DATA}}下单时间：{{keyword3.DATA}}订单金额：{{keyword4.DATA}}关闭时间：{{keyword5.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
...
(6, '订单发货通知', 'send', 'OPENTM401874827', 'PucTX7hcVo177lLt6tLuDTdbmM0pvUosKkdktmW0gK8', '订单发货通知', '{{first.DATA}}订单编号：{{keyword1.DATA}}快递公司：{{keyword2.DATA}}快递单号：{{keyword3.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
(7, '自动发货通知(虚拟物品及卡密)', 'virtualsend', 'OPENTM207793687', 'Z98ttQR5nAq5Nt9RVhEnC8MTivcgX0FMNGMwjwgMySQ', '自动发货通知', '{{first.DATA}}商品名称：{{keyword1.DATA}}订单号：{{keyword2.DATA}}订单金额：{{keyword3.DATA}}卡密信息：{{keyword4.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
...
(10, '换货成功通知', 'refund3', 'OPENTM200605630', 'w-GFyzjUdv-2TIyggevaiPPAR0Jg-3ZF72b2wJXwGJQ', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
(11, '退款申请驳回通知', 'refund2', 'OPENTM200605630', 'w-GFyzjUdv-2TIyggevaiPPAR0Jg-3ZF72b2wJXwGJQ', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
(12, '充值成功通知', 'recharge_ok', 'OPENTM207727673', 'Mc8fIgc6-aUVvq6ZtBNoMkjOtb5keTKG0zC3589N8d4', '充值成功提醒', '{{first.DATA}}充值金额：{{keyword1.DATA}}充值时间：{{keyword2.DATA}}账户余额：{{keyword3.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
...
(14, '会员升级通知(任务处理通知)', 'upgrade', 'OPENTM200605630', 'w-GFyzjUdv-2TIyggevaiPPAR0Jg-3ZF72b2wJXwGJQ', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
(15, '充值成功通知（后台管理员手动）', 'backrecharge_ok', 'OPENTM207727673', 'Mc8fIgc6-aUVvq6ZtBNoMkjOtb5keTKG0zC3589N8d4', '充值成功提醒', '{{first.DATA}}充值金额：{{keyword1.DATA}}充值时间：{{keyword2.DATA}}账户余额：{{keyword3.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
...
(17, '换货发货通知', 'refund4', 'OPENTM401874827', 'PucTX7hcVo177lLt6tLuDTdbmM0pvUosKkdktmW0gK8', '订单发货通知', '{{first.DATA}}订单编号：{{keyword1.DATA}}快递公司：{{keyword2.DATA}}快递单号：{{keyword3.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
...
(21, '商品付款通知', 'saler_goodpay', 'OPENTM200605630', 'bXMz4dbi0G3IPAEUT0zoNqvm10-HSQvrtBzkIkNBalI', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
...
(23, '订单收货通知(卖家)', 'saler_finish', 'OPENTM200605630', 'bXMz4dbi0G3IPAEUT0zoNqvm10-HSQvrtBzkIkNBalI', '任务处理通知', '{{first.DATA}}任务名称：{{keyword1.DATA}}通知类型：{{keyword2.DATA}}{{remark.DATA}}', 0, 'sys', '系统消息通知'),
...
ALTER TABLE `ims_ewei_shop_adv` ADD COLUMN `iswxapp` tinyint(1) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_banner` ADD COLUMN `iswxapp` tinyint(1) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_creditshop_adv` ADD COLUMN `merchid` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_creditshop_comment` ADD COLUMN `merchid` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_creditshop_log` ADD COLUMN `merchid` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_creditshop_verify` ADD COLUMN `merchid` int(11) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `saleupdate30424` tinyint(3) DEFAULT '0';
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `minpriceupdated` tinyint(1) DEFAULT '0';
ALTER TABLE `ims_ewei_shop_goods` ADD COLUMN `unite_total` tinyint(3) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_groups_goods` ADD COLUMN `ishot` tinyint(3) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_groups_order` ADD COLUMN `delete` int(2) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_merch_user` ADD COLUMN `pluginset` text NOT NULL;
ALTER TABLE `ims_ewei_shop_nav` ADD COLUMN `iswxapp` tinyint(1) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_notice` ADD COLUMN `iswxapp` tinyint(3) NOT NULL DEFAULT '0';
ALTER TABLE `ims_ewei_shop_order` ADD COLUMN `lotterydiscountprice` decimal(10,2) NOT NULL DEFAULT '0.00';
ALTER TABLE `ims_ewei_shop_member` ADD COLUMN `openid_wa` varchar(50) DEFAULT NULL;
...
(39, 40, 'lottery', '游戏营销', '1.0', '官方', 1, 'biz', '../addons/ewei_shopv2/static/images/lottery.jpg', '', 0, 0, 1);
